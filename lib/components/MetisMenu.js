...
var MetisMenu = function (_React$Component) {
  ...
  function MetisMenu(props) {
    ...
    _this.classStore = {
      ...
      classSubmenuContainer: (0, _classnames2.default)({ 'metismenu-container': !props.noBuiltInClassNames }, props.classNameSubmenuContainer || props.classNameContainer),
  ...
  _createClass(MetisMenu, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (!(0, _lodash2.default)(this.props.content, nextProps.content)) {
...
MetisMenu.propTypes = {
  ...
  classNameSubmenuContainer: _react.PropTypes.string,

...
class Item extends Component {
  ...
  render () {
    ...
    if (thisHasLevel) {
      ...
      iconLevel = <span className={'metismenu-iconlevel ' + this.props.iconClassPrefix + (this.state.containerVisibility ? this.props.iconLevelUp : this.props.iconLevelDown)} />
    } else {
